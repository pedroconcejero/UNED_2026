...
# Para Curso visualización avanzada master UNED 2026

# A partir de lista mantenida por RStudio:
# https://exts.ggplot2.tidyverse.org/gallery/

# Establece tu directorio de trabajo
# No hace falta si cargaste el proyecto 
...
# install.packages("ggpol") en algunos entornos (el mío, Linux Mint) no funciona
